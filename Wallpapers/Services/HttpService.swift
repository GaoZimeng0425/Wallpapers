...
struct Network {
  ...
  func get<T: Decodable>(path: String, parameters: [String: Any]? = nil) async throws -> T {
    let dataTask = AF.request("\(baseURL)\(path)", method: .get, parameters: parameters, headers: headers).serializingDecodable(T.self)
